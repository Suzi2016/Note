...
<body>
	...
	<br />
	<br />
	<form action="${pageContext.request.contextPath}/login/verify"
		method="post" id="formid">

		<input type="text" name="username" required="required" id="userid"
			placeholder="昵称"><br />
		<br /> <input type="password" name="password" required="required"
			id="passid" placeholder="密码"><br />
		<br />
	</form>
	<p>
		<button id="loginbutton" type="button" value="" onclick="checkData();">登录</button>
		<button id="registerbutton" type="button" value="" class="btn2"
			onclick="window.open('./register','_self')">注册</button>
	</p>
	<br />
